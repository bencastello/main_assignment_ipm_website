...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function createCard(book) {
        return `
            <article class="home-cont-card" onclick="window.location.href='my_books/book_detail.html?id=${book.id}'">
                <div class="home-cont-cover" style="background-image:url('${coverUrl(book)}')"></div>
                <p>${book.title}</p>
            </article>`;
    }
    ...
    async function initHome() {
        ...
        continueList.innerHTML = readingDisplay.length
        ...
        trendingList.innerHTML = trending.map(b => `
            <article class="home-trend-card" onclick="window.location.href='my_books/book_detail.html?id=${b.id}'">
                <div class="home-trend-cover" style="background-image:url('${coverUrl(b)}')"></div>
                <p>${b.title}</p>
            </article>
        `).join("");
    }
